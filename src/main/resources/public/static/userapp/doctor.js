...
Ext.application({
       ...
       stores: [
        ...
        'doctor.SPECIALITY',
        'doctor.DIPLOMAS_GRID',
        'doctor.NOTIFICATIONS_GRID',
        'doctor.GENREQUESTS_GRID',
        'doctor.MEDICAL_ASSOC',
        'doctor.REGASSOC_GRID',
        'doctor.CompanyDiary.DIARY',
        'doctor.COMPANIES_DOCTOR_ANNS_GRID',
        'doctor.COMPANIES_DOCTOR_PEND_ANNS_GRID',
        'doctor.CompanyBooks.BOOK_NOTES',
        'doctor.CompanyDiary.DIARY_ALL',
        'doctor.COMPANIES_DOCTOR_REPL_ANNS_GRID',
        'doctor.DOCTOR_RESIGNATIONS_COMP_ANNS_GRID',
        'doctor.CompanyBooks.BOOK_NOTES_ALL'
    ],
    views: [
        'doctor.MainView',
		'doctor.NotificationsPanel',
        'doctor.NotificationsGrid',
		'doctor.RegRequestForm',
        'doctor.RegRequestsPanel',
        'doctor.RegRequestsGrid',
        'doctor.DiplomasPanel',
        'doctor.DiplomaForm',
		'doctor.RegisteredAssociationForm',
        'doctor.RegisteredAssociationsPanel',
        'doctor.CompanyDiariesPanel',
        'doctor.CompanyBooksPanel',
        'doctor.CompanyBooksPanel',
        'doctor.CompanyInfoViewForm',
        'doctor.PendingCompanyAnnsPanel',
        'doctor.DoctorDiary.entry',
        'doctor.CompanyBooks.NoteForm',
        'doctor.ReplacedCompanyAnnsPanel',
        'doctor.ResignationsCompanyAnnsPanel',
        'doctor.DoctorDiary.Monthly',
    ],
    name: 'MyApp',
    ...
    launch: function() {
        ...
        Ext.create('MyApp.view.doctor.MainView');
