...
Ext.application({
       ...
       stores: [
        ...
        'technician.NOTIFICATIONS_GRID',
        'technician.GENREQUESTS_GRID',
        'technician.SPECIALITY',
        'technician.DIPLOMAS_GRID',
           'technician.CompanyBooks.BOOK_NOTES',
           'technician.CompanyBooks.BOOK_NOTES_ALL',
           'technician.COMPANIES_TECHNICIAN_ANNS_GRID',
           'technician.CompanyDiary.DIARY',
           'technician.CompanyDiary.DIARY_ALL',
           'technician.COMPANIES_TECHNICIAN_PEND_ANNS_GRID',
           'technician.COMPANIES_TECHNICIAN_REPL_ANNS_GRID',
           'technician.TECHNICIAN_RESIGNATIONS_COMP_ANNS_GRID',
           'technician.ship.CompanyBooks.BOOK_NOTES',
           'technician.ship.CompanyBooks.BOOK_NOTES_ALL',
           'technician.ship.COMPANIES_TECHNICIAN_ANNS_GRID',
           'technician.ship.CompanyDiary.DIARY',
           'technician.ship.CompanyDiary.DIARY_ALL',
           'technician.ship.COMPANIES_TECHNICIAN_PEND_ANNS_GRID',
           'technician.ship.COMPANIES_TECHNICIAN_REPL_ANNS_GRID',
           'technician.ship.TECHNICIAN_RESIGNATIONS_COMP_ANNS_GRID',
    ...
    views: [
        'technician.MainView',
	    'technician.NotificationsPanel',
        'technician.NotificationsGrid',
        'technician.RegRequestForm',
        'technician.RegRequestsPanel',
        'technician.RegRequestsGrid',
        'technician.DiplomasPanel',
        'technician.DiplomaForm',
        'technician.CompanyBooksPanel',
        'technician.CompanyBooks.NoteForm',
        'technician.CompanyInfoViewForm',
        'technician.CompanyDiariesPanel',
        'technician.TechnicianDiary.entry',
        'technician.TechnicianDiary.Monthly',
        'technician.PendingCompanyAnnsPanel',
        'technician.ReplacedCompanyAnnsPanel',
        'technician.ResignationsCompanyAnnsPanel',
        'technician.ship.CompanyInfoViewForm',
        'technician.ship.CompanyBooks.NoteForm',
        'technician.ship.CompanyBooksPanel',
        'technician.ship.CompanyDiariesPanel',
        'technician.ship.TechnicianDiary.Monthly',
        'technician.ship.PendingCompanyAnnsPanel',
        'technician.ship.ReplacedCompanyAnnsPanel',
        'technician.ship.ResignationsCompanyAnnsPanel',

        'company.TechnicianAnn.ShipForm',
        'company.TechnicianBooks.ShipBookForm',
        'technician.ship.ShipTechForm',
    ...
    launch: function() {
        ...
        Ext.create('MyApp.view.technician.MainView');
