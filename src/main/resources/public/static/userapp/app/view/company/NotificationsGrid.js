/*
 * File: app/view/company/NotificationsGrid.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.NotificationsGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.companynotificationsgrid',

    requires: [
        'MyApp.view.company.NotificationsGridViewModel',
        'MyApp.view.company.NotificationsGridViewController',
    ...
    controller: 'companynotificationsgrid',
    viewModel: {
        type: 'companynotificationsgrid'
    },
    autoScroll: true,
    id: 'companynotificationgrid',
    itemId: 'companynotificationgrid',
    title: 'Ενημερώσεις',
    autoLoad: true,
    columnLines: false,
    reserveScrollbar: true,
    scroll: 'vertical',
    store: 'company.NOTIFICATIONS_GRID',
