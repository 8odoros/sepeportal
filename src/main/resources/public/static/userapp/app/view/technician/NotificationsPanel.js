/*
 * File: app/view/technician/NotificationsPanel.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.NotificationsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.techniciannotificationspanel',

    requires: [
        'MyApp.view.technician.NotificationsPanelViewModel',
        'MyApp.view.technician.NotificationsGrid',
        'Ext.grid.Panel',
        'Ext.XTemplate',
        'Ext.panel.Tool'
    ],
    ...
    viewModel: {
        type: 'techniciannotificationspanel'
    },
    ...
    items: [
        {
            xtype: 'techniciannotificationsgrid',
            manageHeight: false,
            flex: 1
        },
        {
