/*
 * File: app/view/company/DoctorBooks/BookForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.DoctorBooks.BookForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companydoctorbooksbookform',

    requires: [
        'MyApp.view.company.DoctorBooks.BookFormViewModel',
        'MyApp.view.company.DoctorBooks.BookFormViewController',
        'Ext.form.Panel',
    ...
    controller: 'companydoctorbooksbookform',
    viewModel: {
        type: 'companydoctorbooksbookform'
    },
    constrain: true,
    draggable: false,
    frame: true,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            store: 'company.PTL_IE_ANN_COMP_BR_COMBO',
    ...
    dockedItems: [
        {
            ...
            dock: 'bottom',
            html: '',
            id: 'compdoctorbook_save_submit_toolbar',
            style: {
