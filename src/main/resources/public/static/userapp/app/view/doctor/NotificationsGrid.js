/*
 * File: app/view/doctor/NotificationsGrid.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.doctor.NotificationsGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.doctornotificationsgrid',

    requires: [
        'MyApp.view.doctor.NotificationsGridViewModel',
        'MyApp.view.doctor.NotificationsGridViewController',
    ...
    controller: 'doctornotificationsgrid',
    viewModel: {
        type: 'doctornotificationsgrid'
    },
    autoScroll: true,
    id: 'doctornotificationgrid',
    itemId: 'doctornotificationgrid',
    title: 'Ενημερώσεις',
    autoLoad: true,
    columnLines: false,
    reserveScrollbar: true,
    scroll: 'vertical',
    store: 'doctor.NOTIFICATIONS_GRID',
