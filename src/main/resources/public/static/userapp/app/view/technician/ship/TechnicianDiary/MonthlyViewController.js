/*
 * File: app/view/technician/ship/TechnicianDiary/MonthlyViewController.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.ship.TechnicianDiary.MonthlyViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.technicianshiptechniciandiarymonthly',
    ...
    onView_TECH_SCHEDULE: function(button, e, eOpts) {
        ...
        if(form.isValid()){
            ...
            formWindow.down('grid').store.proxy.setUrl("/vCompTaSannDiary/search/findByMonthAndYear?"+"month="+month+"&year="+year);
