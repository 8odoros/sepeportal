/*
 * File: app/view/doctor/NotificationsPanel.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.doctor.NotificationsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.doctornotificationspanel',

    requires: [
        'MyApp.view.doctor.NotificationsPanelViewModel',
        'MyApp.view.doctor.NotificationsGrid',
        'Ext.grid.Panel',
        'Ext.XTemplate',
        'Ext.panel.Tool'
    ],
