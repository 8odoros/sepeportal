...
Ext.define('MyApp.view.admin.UserSafetyTechnicianGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.adminusersafetytechniciangrid',

    requires: [
        'MyApp.view.admin.UserSafetyTechnicianGridViewModel',
        'MyApp.view.admin.UserSafetyTechnicianGridViewController',
    ...
    controller: 'adminusersafetytechniciangrid',
    viewModel: {
        type: 'adminusersafetytechniciangrid'
    },
    autoScroll: true,
    id: 'adminusersafetytechniciangrid',
    itemId: 'adminusersafetytechniciangrid',
    title: 'Λίστα Χρηστών',
    autoLoad: false,
    columnLines: false,
    reserveScrollbar: true,
    scroll: 'vertical',
    store: 'admin.USER_SAFETY_TECHNICIAN_GRID',
                ...
                },
                {
                    ...
                    handler: function(dataview, eOpts) {
                        ...
                        if (username=='' && afm=='' && email=='') {
                            ...
                            store.getProxy().setUrl('/SpPtlVUserSafetyTechnician/search/findUsersByCriteria');
    ...
    listeners: {
        edit: function (e) {
            var me = this;
            Ext.Ajax.request({
                url: "/userExtraInfo/editUserSafetyTechnician",
                method: 'POST',
                params: {
