/*
 * File: app/view/technician/CompanyInfoViewFormViewController.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.CompanyInfoViewFormViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.techniciancompanyinfoviewform',
            ...
            var successAns = function(options, success, response) {
                ...
                if (Ext.JSON.decode(response.responseText).success) {
                    ...
                    if (Ext.JSON.decode(response.responseText).visitConflict)
                    {
                        ...
                        Ext.Msg.alert('Αποτυχία Αποδοχής', 'Κάποιες από τις επισκέψεις επικαλύπτονται από άλλες που έχετε ήδη αποδεχτεί.');
                    }
