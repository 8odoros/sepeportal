/*
 * File: app/view/technician/ActiveCompanyAnnsPanel.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.ActiveCompanyAnnsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.technicianactivecompanyannspanel',

    requires: [
        'MyApp.view.technician.ActiveCompanyAnnsPanelViewModel',
        'Ext.grid.Panel',
    ...
    viewModel: {
        type: 'technicianactivecompanyannspanel'
    },
    ...
    items: [
        {
            ...
            icon_dbl_click_handler: function(record) {
                ...
                form.getForm().findField('only_view').setValue("activation");
