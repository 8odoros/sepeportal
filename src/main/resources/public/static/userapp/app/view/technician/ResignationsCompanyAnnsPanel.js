/*
 * File: app/view/technician/ResignationsCompanyAnnsPanel.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.ResignationsCompanyAnnsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.technicianresignationscompanyannspanel',

    requires: [
        'MyApp.view.technician.ResignationsCompanyAnnsPanelViewModel',
        'Ext.grid.Panel',
    ...
    viewModel: {
        type: 'technicianresignationscompanyannspanel'
    },
    ...
    items: [
        {
            ...
            icon_dbl_click_handler: function(record) {
                ...
                Ext.getCmp('companyTaInfoForm_resignation_action_toolbar').show();
            ...
            autoScroll: true,
            height: '50%',
            id: 'technicianActiveCompany_Anns',
            itemId: 'technicianActiveCompany_Anns',
        ...
        },
        {
            ...
            autoScroll: true,
            height: '50%',
            id: 'technicianCompany_Resignations',
            itemId: 'technicianCompany_Resignations',
            title: 'Αρχείο Αναγγελιών Παύσης Καθηκόντων',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'technician.TECHNICIAN_RESIGNATIONS_COMP_ANNS_GRID',
            columns: [
                {
                    xtype: 'rownumberer'
                },
