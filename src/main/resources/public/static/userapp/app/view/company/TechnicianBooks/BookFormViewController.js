/*
 * File: app/view/company/TechnicianBooks/BookFormViewController.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.TechnicianBooks.BookFormViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.companytechnicianbooksbookform',
    ...
    onSubmit_COMPANY_TECHNICIAN_BOOK: function(button, e, eOpts) {
        ...
        var submitfun = function(){
            ...
            var book = store.findRecord('compPtlBranchId', values.compPtlBranchId);
