...
Ext.define('MyApp.view.company.exypp.CompanyDoctorInfoViewForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companyexyppcompanydoctorinfoviewform',

    requires: [
        'MyApp.view.company.exypp.CompanyInfoViewFormViewModel',
        'MyApp.view.company.exypp.CompanyDoctorInfoViewFormViewController',
    ...
    controller: 'companyexyppcompanydoctorinfoviewform',
    viewModel: {
    ...
    dockedItems: [
        {
            ...
            id: 'companyIeInfoForm_accept_reject_toolbar1',
            style: {
        ...
        },
        {
            ...
            hidden: true,
            html: '<span style="color:#696969;font-size:12px;"><em><br>*Επιλέξτε Αποδοχή ή Απόρριψη της αναγγελίας</em></span>',
            id: 'companyIeInfoForm_replace_action_toolbar1',
            style: {
                'background-color': '#f5f5f5'
            },
            layout: {
        ...
        },
        {
            ...
            id: 'companyIeInfoForm_resignation_action_toolbar1',
            style: {
                'background-color': '#f5f5f5'
            },
            layout: {
