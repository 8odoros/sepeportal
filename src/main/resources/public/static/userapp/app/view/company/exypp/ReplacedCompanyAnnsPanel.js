...
Ext.define('MyApp.view.company.exypp.ReplacedCompanyAnnsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companyexyppreplacedcompanyannspanel',
    ...
    viewModel: {
        type: 'companyexyppreplacedcompanyannspanel'
    },
    ...
    items: [
        {
            ...
            icon_dbl_click_handler: function(record) {
                ...
                Ext.getCmp('companyTaInfoForm_replace_action_toolbar1').show();
                else
                Ext.getCmp('companyTaInfoForm_replace_action_toolbar1').hide();
            ...
            autoScroll: true,
            height: '100%',
            id: 'companyexyppReplacedCompany_Anns',
            itemId: 'companyexyppReplacedCompany_Anns',
            title: 'Αναγγελίες στις οποίες σας έχει γίνει Παύση - Αντικατάσταση',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'company.exypp.COMPANIES_TECHNICIAN_REPL_ANNS_GRID',
            columns: [
                {
                    xtype: 'rownumberer'
                },
