/*
 * File: app/view/technician/PendingCompanyAnnsPanel.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.PendingCompanyAnnsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.technicianpendingcompanyannspanel',

    requires: [
        'MyApp.view.technician.PendingCompanyAnnsPanelViewModel',
        'Ext.grid.Panel',
    ...
    viewModel: {
        type: 'technicianpendingcompanyannspanel'
    },
    id: 'projectanncompany8',
    ...
    items: [
        {
            ...
            icon_dbl_click_handler: function(record) {
                ...
                if (record.get('taAnnTaStatus')===1 && record.get('taAnnStatus')===0 ){
                    Ext.getCmp('companyTaInfoForm_accept_reject_toolbar').hide();
                }
                else {
                    Ext.getCmp('companyTaInfoForm_accept_reject_toolbar').show();
                }
            ...
            autoScroll: true,
            height: '100%',
            id: 'technicianPendingCompany_Anns',
            itemId: 'technicianPendingCompany_Anns',
            title: 'Αναγγελίες σε Εκρεμμότητα',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'technician.COMPANIES_TECHNICIAN_PEND_ANNS_GRID',
            columns: [
                {
                    xtype: 'rownumberer'
                },
