/*
 * File: app/view/company/TechnicianBooks/NoteForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.TechnicianBooks.NoteForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companytechnicianbooksnoteform',

    requires: [
        'MyApp.view.company.TechnicianBooks.NoteFormViewModel',
        'MyApp.view.company.TechnicianBooks.NoteFormViewController',
    ...
    controller: 'companytechnicianbooksnoteform',
    viewModel: {
        type: 'companytechnicianbooksnoteform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    dockedItems: [
        {
            ...
            hidden: true,
            html: '',
            id: 'comptechniciannote_save_submit_toolbar',
            style: {
