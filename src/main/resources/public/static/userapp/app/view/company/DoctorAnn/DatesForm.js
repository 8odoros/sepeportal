/*
 * File: app/view/company/DoctorAnn/DatesForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.DoctorAnn.DatesForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companydoctoranndatesform',

    requires: [
        'MyApp.view.company.DoctorAnn.DatesFormViewModel',
        'MyApp.view.company.DoctorAnn.DatesFormViewController',
    ...
    controller: 'companydoctoranndatesform',
    viewModel: {
        type: 'companydoctoranndatesform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    dockedItems: [
        {
            ...
            id: 'compdoctanndates_sumbit_toolbar',
            style: {
            ...
            items: [
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onCheck_COMPANY_DOCTOR_ANN_DATES',
                            scope: 'controller'
                        }
                    }
                }
