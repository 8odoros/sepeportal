/*
 * File: app/view/technician/CompanyBooks/NoteForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.CompanyBooks.NoteForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.techniciancompanybooksnoteform',

    requires: [
        'MyApp.view.technician.CompanyBooks.NoteFormViewModel',
        'MyApp.view.technician.CompanyBooks.NoteFormViewController',
    ...
    controller: 'techniciancompanybooksnoteform',
    viewModel: {
        type: 'techniciancompanybooksnoteform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    dockedItems: [
        {
            ...
            dock: 'bottom',
            html: '',
            id: 'technicianbooknote_save_submit_toolbar',
            style: {
