...
Ext.define('MyApp.view.company.exypp.ResignationsCompanyDoctorAnnsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companyexyppresignationscompanydoctorannspanel',
    ...
    viewModel: {
        type: 'companyexyppresignationscompanydoctorannspanel'
    },
    ...
    items: [
        {
            ...
            icon_dbl_click_handler: function(record) {
                ...
                Ext.getCmp('companyIeInfoForm_resignation_action_toolbar1').show();
            ...
            autoScroll: true,
            height: '50%',
            id: 'companyexyppActiveCompanyDoctor_Anns',
            itemId: 'companyexyppActiveCompanyDoctor_Anns',
            title: 'Επιχειρήσεις με ενεργή σύμβαση',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'company.exypp.COMPANIES_DOCTOR_ANNS_GRID',
            columns: [
                {
                    xtype: 'rownumberer'
                },
        ...
        },
        {
            ...
            autoScroll: true,
            height: '50%',
            id: 'companyexyppCompanyDoctor_Resignations',
            itemId: 'companyexyppCompanyDoctor_Resignations',
            title: 'Αρχείο Αναγγελιών Παύσης Καθηκόντων',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'company.exypp.DOCTOR_RESIGNATIONS_COMP_ANNS_GRID',
            columns: [
                {
                    xtype: 'rownumberer'
                },
