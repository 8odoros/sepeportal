/*
 * File: app/view/technician/ship/CompanyBooks/NoteForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.ship.CompanyBooks.NoteForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.technicianshipcompanybooksnoteform',

    requires: [
        'MyApp.view.technician.ship.CompanyBooks.NoteFormViewModel',
        'MyApp.view.technician.ship.CompanyBooks.NoteFormViewController',
    ...
    controller: 'technicianshipcompanybooksnoteform',
    viewModel: {
        type: 'technicianshipcompanybooksnoteform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    dockedItems: [
        {
            ...
            dock: 'bottom',
            html: '',
            id: 'technicianshipbooknote_save_submit_toolbar',
            style: {
