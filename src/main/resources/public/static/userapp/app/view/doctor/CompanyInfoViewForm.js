/*
 * File: app/view/doctor/CompanyInfoViewForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.doctor.CompanyInfoViewForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.doctorcompanyinfoviewform',

    requires: [
        'MyApp.view.doctor.CompanyInfoViewFormViewModel',
        'MyApp.view.doctor.CompanyInfoViewFormViewController',
    ...
    controller: 'doctorcompanyinfoviewform',
    viewModel: {
        type: 'doctorcompanyinfoviewform'
    },
    constrain: true,
    draggable: false,
    frame: true,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            focusOnToFront: false,
                            toFrontOnShow: false,
                            title: 'Διεύθυνση Υποκαταστήματος Ελέγχου Ιατρού ',
                            items: [
                                {
                                    xtype: 'textfield',
                                    anchor: '100%',
    ...
    dockedItems: [
        {
            ...
            id: 'companyInfoForm_accept_reject_toolbar',
            style: {
        ...
        },
        {
            ...
            hidden: true,
            html: '<span style="color:#696969;font-size:12px;"><em><br>*Επιλέξτε Αποδοχή ή Απόρριψη της αναγγελίας</em></span>',
            id: 'companyInfoForm_replace_action_toolbar',
            style: {
                'background-color': '#f5f5f5'
            },
            layout: {
        ...
        },
        {
            ...
            id: 'companyInfoForm_resignation_action_toolbar',
            style: {
                'background-color': '#f5f5f5'
            },
            layout: {
