/*
 * File: app/view/company/TechnicianBooks/ShipBookForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.TechnicianBooks.ShipBookForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companytechnicianbooksshipbookform',

    requires: [
        'MyApp.view.company.TechnicianBooks.ShipBookFormViewModel',
        'MyApp.view.company.TechnicianBooks.ShipBookFormViewController',
        'Ext.form.Panel',
    ...
    controller: 'companytechnicianbooksshipbookform',
    viewModel: {
        type: 'companytechnicianbooksshipbookform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            xtype: 'combobox',
                            anchor: '100%',
                            fieldLabel: 'Πλοίο Ενεργής Αναγγελίας',
                            labelWidth: 200,
                            name: 'compShipId',
                            validateOnChange: false,
                            validateOnBlur: false,
                            ...
                            store: 'company.PTL_TA_ANN_COMP_SH_COMBO',
                            valueField: 'shipId'
                        }
                    ]
                },
                {
                    xtype: 'displayfield',
                    flex: 1,
                    value: 'Το βιβλίο τηρείται ανά πλοίο'
                }
            ]
        }
    ],
    dockedItems: [
        {
            ...
            dock: 'bottom',
            html: '',
            id: 'comptechnicianshipbook_save_submit_toolbar',
            style: {
