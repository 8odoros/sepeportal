...
Ext.define('MyApp.view.admin.UserEmployeeGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.adminuseremployeegrid',

    requires: [
        'MyApp.view.admin.UserEmployeeGridViewModel',
        'MyApp.view.admin.UserEmployeeGridViewController',
    ...
    controller: 'adminuseremployeegrid',
    viewModel: {
        type: 'adminuseremployeegrid'
    },
    autoScroll: true,
    id: 'adminuseremployeegrid',
    itemId: 'adminuseremployeegrid',
    title: 'Λίστα Χρηστών',
    autoLoad: false,
    columnLines: false,
    reserveScrollbar: true,
    scroll: 'vertical',
    store: 'admin.USER_EMPLOYEE_GRID',
                ...
                },
                {
                    ...
                    handler: function(dataview, eOpts) {
                        ...
                        if (username=='' && afm=='' && email=='') {
                            ...
                            store.getProxy().setUrl('/SpPtlVUserEmployee/search/findUsersByCriteria');
    ...
    listeners: {
        edit: function (e) {
            var me = this;
            Ext.Ajax.request({
                url: "/userExtraInfo/editUserEmployee",
                method: 'POST',
                params: {
