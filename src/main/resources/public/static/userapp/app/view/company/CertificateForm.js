...
Ext.define('MyApp.view.company.CertificateForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companycertificateform',

    requires: [
        'MyApp.view.company.CertificateFormViewModel',
        'MyApp.view.company.CertificateFormViewController',
    ...
    controller: 'companycertificateform',
    viewModel: {
        type: 'companycertificateform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    width: 800,
    closable: false,
    title: 'Φόρμα χορήγησης πιστοποιητικού του παρ.2γ, άρθρου 73 του Ν.4412/2016',
    //modal: true,
            ...
            items: [
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onDelete_COMPANY_CERTIFICATE',
                            scope: 'controller'
                        }
                    }
                },
                ...
                },
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onSubmit_COMPANY_CERTIFICATE',
                            scope: 'controller'
                        }
                    }
                }
