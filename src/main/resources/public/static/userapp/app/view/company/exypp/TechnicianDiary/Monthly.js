...
Ext.define('MyApp.view.company.exypp.TechnicianDiary.Monthly', {
    extend: 'Ext.window.Window',
    alias: 'widget.companyexypptechniciandiarymonthly',

    requires: [
        'MyApp.view.company.exypp.TechnicianDiary.MontlyViewModel',
        'MyApp.view.company.exypp.TechnicianDiary.MonthlyViewController',
        'Ext.panel.Tool',
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
    ...
    controller: 'companyexypptechniciandiarymonthly',
    viewModel: {
        type: 'companyexypptechniciandiarymonthly'
    },
    constrain: true,
    draggable: false,
    frame: true,
