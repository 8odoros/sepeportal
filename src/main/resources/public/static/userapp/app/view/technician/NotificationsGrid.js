/*
 * File: app/view/technician/NotificationsGrid.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.NotificationsGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.techniciannotificationsgrid',

    requires: [
        'MyApp.view.technician.NotificationsGridViewModel',
        'MyApp.view.technician.NotificationsGridViewController',
    ...
    controller: 'techniciannotificationsgrid',
    viewModel: {
        type: 'techniciannotificationsgrid'
    },
    autoScroll: true,
    id: 'techniciannotificationgrid',
    itemId: 'techniciannotificationgrid',
    title: 'Ενημερώσεις',
    autoLoad: true,
    columnLines: false,
    reserveScrollbar: true,
    scroll: 'vertical',
    store: 'technician.NOTIFICATIONS_GRID',
