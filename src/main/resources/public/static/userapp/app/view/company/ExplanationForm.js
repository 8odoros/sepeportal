/*
 * File: app/view/company/ExplanationForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.ExplanationForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companyexplanationform',

    requires: [
        'MyApp.view.company.ExplanationFormViewModel',
        'MyApp.view.company.ExplanationFormViewController',
    ...
    controller: 'companyexplanationform',
    viewModel: {
        type: 'companyexplanationform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    width: 800,
    closable: false,
    title: 'Φόρμα Υποβολής Εξηγήσεων μετά από Έλεγχο',
    //modal: true,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    forceSelection: true,
                                    pageSize: 25,
                                    store: 'company.EMP_INCHARGES',
                                    valueField: 'abbr',
                                    listeners: {
                                        expand: 'onInchargesExpand'
                                    }
                                }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            padding: '0 0 8 185',
                            html: '* <i>Το μεγαλύτερο αποδεκτό μήκος για το πεδίο είναι 500 χαρακτήρες</i>'
                        },
                        {
                            xtype: 'hiddenfield',
                            anchor: '100%',
    ...
    dockedItems: [
        {
            ...
            id: 'compexplanation_save_submit_toolbar',
            style: {
            ...
            items: [
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onDelete_COMPANY_EXPLANATION',
                            scope: 'controller'
                        }
                    }
                },
                ...
                },
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onSubmit_COMPANY_EXPLANATION',
                            scope: 'controller'
                        }
                    }
                }
    ...
    onTeKeSelect: function(combo, records, eOpts) {
        var getnext = combo.up('form').getForm().findField('sepeDept');
        getnext.clearValue();
        getnext.enable();
    },
    ...
    onDeleteClick: function(button, e, eOpts) {
        ...
        button.up('form').getForm().findField('attachedDocDescr').setValue();
