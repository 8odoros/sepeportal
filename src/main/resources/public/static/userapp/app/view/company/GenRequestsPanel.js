...
Ext.define('MyApp.view.company.GenRequestsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companygenrequestspanel',

    requires: [
        'MyApp.view.company.GenRequestsPanelViewModel',
        'MyApp.view.company.GenRequestsPanelViewController',
        'Ext.grid.Panel',
    ...
    controller: 'companygenrequestspanel',
    viewModel: {
        type: 'companygenrequestspanel'
    },
    id: 'complaints6',
    ...
    items: [
        {
            ...
            flex: 1,
            autoScroll: true,
            id: 'companygenreqgrid',
            itemId: 'companygenreqgrid',
            title: 'Λοιπές αιτήσεις/γνωστοποιήσεις',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'company.GENREQUESTS_GRID',
            columns: [
                {
                    xtype: 'rownumberer',
                    flex: 2
