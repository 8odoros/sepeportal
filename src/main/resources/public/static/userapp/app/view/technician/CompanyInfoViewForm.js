/*
 * File: app/view/technician/CompanyInfoViewForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.CompanyInfoViewForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.techniciancompanyinfoviewform',

    requires: [
        'MyApp.view.technician.CompanyInfoViewFormViewModel',
        'MyApp.view.technician.CompanyInfoViewFormViewController',
    ...
    controller: 'techniciancompanyinfoviewform',
    viewModel: {
        type: 'techniciancompanyinfoviewform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    dockedItems: [
        {
            ...
            id: 'companyTaInfoForm_accept_reject_toolbar',
            style: {
        ...
        },
        {
            ...
            hidden: true,
            html: '<span style="color:#696969;font-size:12px;"><em><br>*Επιλέξτε Αποδοχή ή Απόρριψη της αναγγελίας</em></span>',
            id: 'companyTaInfoForm_replace_action_toolbar',
            style: {
                'background-color': '#f5f5f5'
            },
            layout: {
        ...
        },
        {
            ...
            id: 'companyTaInfoForm_resignation_action_toolbar',
            style: {
                'background-color': '#f5f5f5'
            },
            layout: {
    ...
    onWindowBeforeDestroy: function(component, eOpts) {
        ...
        else if(component.down('form').getForm().findField('only_view').getValue()==="activation"){
            var view=Ext.getCmp('technicianmainView');
            var center = view.getComponent('contentPanel');
            center.removeAll();
