/*
 * File: app/view/company/TechnicianAnn/ReplaceInfoForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.TechnicianAnn.ReplaceInfoForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companytechnicianannreplaceinfoform',

    requires: [
        'MyApp.view.company.TechnicianAnn.ReplaceInfoFormViewModel',
        'MyApp.view.company.TechnicianAnn.ReplaceInfoFormViewController',
    ...
    controller: 'companytechnicianannreplaceinfoform',
    viewModel: {
        type: 'companytechnicianannreplaceinfoform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    width: 800,
    closable: false,
    title: 'Αντικατάσταση Αναγγελίας Τεχνικού Ασφάλειας',
    //modal: true,
    ...
    dockedItems: [
        {
            ...
            id: 'replaceformtechnicianann_toolbar',
            style: {
