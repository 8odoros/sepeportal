...
Ext.define('MyApp.view.company.exypp.PendingCompanyAnnsPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.companyexypppendingcompanyannspanel',
    ...
    items: [
        {
            ...
            icon_dbl_click_handler: function(record) {
                ...
                if (record.get('taAnnTaStatus')===1 && record.get('taAnnStatus')===0 ){
                    ...
                    Ext.getCmp('companyTaInfoForm_accept_reject_toolbar1').show();
                }
            ...
            autoScroll: true,
            height: '100%',
            id: 'companyPendingCompany_Anns',
            itemId: 'companyPendingCompany_Anns',
            title: 'Αναγγελίες σε Εκρεμμότητα',
            autoLoad: true,
            columnLines: false,
            reserveScrollbar: true,
            scroll: 'vertical',
            store: 'company.exypp.COMPANIES_TECHNICIAN_PEND_ANNS_GRID',
            columns: [
                {
                    xtype: 'rownumberer'
                },
