/*
 * File: app/view/doctor/DoctorDiary/Monthly.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.doctor.DoctorDiary.Monthly', {
    extend: 'Ext.window.Window',
    alias: 'widget.doctordoctordiarymonthly',

    requires: [
        'MyApp.view.doctor.DoctorDiary.MonthlyViewModel',
        'MyApp.view.doctor.DoctorDiary.MonthlyViewController',
        'Ext.panel.Tool',
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
    ...
    controller: 'doctordoctordiarymonthly',
    viewModel: {
        type: 'doctordoctordiarymonthly'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    items: [
        {
            xtype: 'gridpanel',
            flex: 1,
            id: 'doctorMonthly_Diary',
            itemId: 'doctorMonthly_Diary',
            manageHeight: false,
            title: '',
            columnLines: false,
