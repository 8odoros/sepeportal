...
Ext.define('MyApp.view.technician.ship.ShipTechForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companytechnicianannshiptechform',

    requires: [
        'MyApp.view.technician.ship.ShipTechViewModel',
        'MyApp.view.technician.ship.ShipTechFormViewController',
    ...
    onAFMBlur: function(component, event, eOpts) {
        ...
        if (component.getValue().length>0){
            ...
            var formPart = component.up('form').getForm();
                store.getProxy().extraParams = {afm:component.getValue(), ta:'tas'};
