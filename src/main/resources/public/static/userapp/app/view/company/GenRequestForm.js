...
Ext.define('MyApp.view.company.GenRequestForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companygenrequestform',

    requires: [
        'MyApp.view.company.GenRequestFormViewModel',
        'MyApp.view.company.GenRequestFormViewController',
    ...
    controller: 'companygenrequestform',
    viewModel: {
        type: 'companygenrequestform'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    width: 800,
    closable: false,
    title: 'Φόρμα Αίτησης / Γνωστοποίησης',
    //modal: true,
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    height: 24,
                                                    padding: '5 0 0 0',
                                                    text: 'Aπαιτούμενα επισυναπτόμενα έντυπα'
                                                },
                                                {
                                                    xtype: 'button',
                                                    focusCls: ' ',
                            ...
                            items: [
                                {
                                    ...
                                    validateOnBlur: false,
                                    boxLabel: 'Αποδέχομαι το περιεχόμενο των δηλωθέντων στοιχείων μου και δηλώνω υπεύθυνα και με γνώση των συνεπειών του ν. 1599/1986, όπως ισχύει, ότι τα στοιχεία που δηλώνω είναι αληθή. '+
                                    'Δηλώνω ρητά ότι σύμφωνα με το Γενικό Κανονισμό για την Προστασία Δεδομένων (ΕΕ)2016/679 και την εκάστοτε ισχύουσα νομοθεσία για την Προστασία των Προσωπικών Δεδομένων συγκατατίθεμαι για τη συλλογή, τήρηση και επεξεργασία από το Σώμα Επιθεώρησης Εργασίας, των δεδομένων προσωπικού χαρακτήρα που δηλώνω με την παρούσα δήλωση. '+
                                    'Είμαι ενήμερος ότι τα συλλεχθέντα στοιχεία μπορούν να τύχουν επεξεργασίας από άλλες υπηρεσίες του Δημοσίου ή ΟΤΑ κατά τα οριζόμενα στο άρθρο 6 παρ. 1 περ. γ του Γενικού Κανονισμού για την Προστασία Δεδομένων (ΕΕ) 2016/679 και την εκάστοτε ισχύουσα νομοθεσία για την Προστασία των Προσωπικών Δεδομένων και για τα οριζόμενα στο άρθρο 9 του ν. 4164/2013 (Α’ 156). '+
                                    'Επίσης, γνωρίζω ότι έχω το δικαίωμα πρόσβασης στα αρχεία του Σώματος Επιθεώρησης Εργασίας για έλεγχο των στοιχείων που με αφορούν.',
                                    inputValue: '1',
                                    uncheckedValue: '0'
                                }
                            ]
            ...
            items: [
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onDelete_COMPANY_GENREQUEST',
                            scope: 'controller'
                        }
                    }
                },
                ...
                },
                {
                    ...
                    listeners: {
                        click: {
                            fn: 'onSubmit_COMPANY_GENREQUEST',
                            scope: 'controller'
                        }
                    }
                }
    ...
    onreqSubjectChange: function(field, newValue, oldValue, eOpts) {
        if(newValue!==oldValue && oldValue!==null){
            field.up('form').getForm().findField('requestTypeId').setValue(null);
    ...
    onReqTypeBeforeSelect: function(combo, record, index, eOpts) {
        ...
        {
            vfc.items.getAt(1).items.getAt(1).show();
            if (record.get('spGreqHelplDocId') != null) vfc.items.getAt(1).items.getAt(1).items.getAt(2).show();
            else vfc.items.getAt(1).items.getAt(1).items.getAt(2).hide();
        }
        if (record.get('spGreqRequiredDoc') == 1)
        {
            combo.up('form').getForm().findField('file').allowBlank = false;
            combo.up('form').getForm().findField('file').allowOnlyWhiteSpace = false;
        }
        else
        {
            combo.up('form').getForm().findField('file').allowBlank = true;
            combo.up('form').getForm().findField('file').allowOnlyWhiteSpace = true;
        }
        if (record.get('spGreqConfirmText') == 1)
        {
            combo.up('form').getForm().findField('terms').up().show();
        }
        else
        {
            combo.up('form').getForm().findField('terms').up().hide();
        }
