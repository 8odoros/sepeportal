/*
 * File: app/view/company/DoctorBooks/NoteForm.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.company.DoctorBooks.NoteForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.companydoctorbooksnoteform',

    requires: [
        'MyApp.view.company.DoctorBooks.NoteFormViewModel',
        'MyApp.view.company.DoctorBooks.NoteFormViewController',
    ...
    controller: 'companydoctorbooksnoteform',
    viewModel: {
        type: 'companydoctorbooksnoteform'
    },
    constrain: true,
    draggable: false,
    frame: true,
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            xtype: 'textfield',
                            anchor: '100%',
                            fieldLabel: 'Παραρτήματα Υπόδειξης',
                            labelWidth: 180,
    ...
    dockedItems: [
        {
            ...
            hidden: true,
            html: '',
            id: 'compdoctornote_save_submit_toolbar',
            style: {
            ...
            items: [
                {
                    ...
                    listeners: {
                        click: 'onSubmit_COMPANY_DOCTOR_BOOK'
                    }
                }
            ]
        }
