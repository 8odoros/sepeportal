/*
 * File: app/view/technician/TechnicianDiary/Monthly.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.view.technician.TechnicianDiary.Monthly', {
    extend: 'Ext.window.Window',
    alias: 'widget.techniciantechniciandiarymonthly',

    requires: [
        'MyApp.view.technician.TechnicianDiary.MontlyViewModel',
        'MyApp.view.technician.TechnicianDiary.MonthlyViewController',
        'Ext.panel.Tool',
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
    ...
    controller: 'techniciantechniciandiarymonthly',
    viewModel: {
        type: 'techniciantechniciandiarymonthly'
    },
    constrain: true,
    draggable: false,
    frame: true,
    ...
    items: [
        {
            xtype: 'gridpanel',
            flex: 1,
            id: 'technicianMonthly_Diary',
            itemId: 'technicianMonthly_Diary',
            manageHeight: false,
            title: '',
            columnLines: false,
            ...
            pnl = this;
                ...
                Ext.define('Ext.ux.converter.GridToHtmlTable', {
                    ...
                    tableTemplate: [
                        ...
                        '      <td>&nbsp&nbspΗμερομηνία&nbsp&nbsp</td><td>&nbsp&nbspΏρα&nbsp&nbsp</td><td>&nbsp&nbspΔιάρκεια&nbsp&nbsp</td><td>&nbsp&nbspΟργανισμός&nbsp&nbsp</td>',
                        '   </thead>',
                        '   <tbody>',
                        '       {bodyRows}',
                        '   </tbody>',
