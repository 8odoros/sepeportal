/*
 * File: app/store/doctor/COMPANIES_DOCTOR_PEND_ANNS_GRID.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.store.doctor.COMPANIES_DOCTOR_PEND_ANNS_GRID', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            pageSize: 10,
            remoteSort: true,
            storeId: 'doctor.COMPANIES_DOCTOR_PEND_ANNS_GRID',
            autoLoad: false,
            fields: [
                {
                    name: 'subStatus'
