/*
 * File: app/store/technician/TECHNICIAN_RESIGNATIONS_COMP_ANNS_GRID.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.store.technician.TECHNICIAN_RESIGNATIONS_COMP_ANNS_GRID', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            pageSize: 10,
            remoteSort: true,
            storeId: 'technician.TECHNICIAN_RESIGNATIONS_COMP_ANNS_GRID',
            autoLoad: false,
            fields: [
                {
                    name: 'subStatus'
