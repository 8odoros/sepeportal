...
Ext.define('MyApp.store.company.exypp.DOCTOR_RESIGNATIONS_COMP_ANNS_GRID', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            pageSize: 10,
            remoteSort: true,
            storeId: 'company.exypp.DOCTOR_RESIGNATIONS_COMP_ANNS_GRID',
            autoLoad: false,
            fields: [
                {
                    name: 'subStatus'
