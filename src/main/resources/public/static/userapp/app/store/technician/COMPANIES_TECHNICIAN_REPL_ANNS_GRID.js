/*
 * File: app/store/technician/COMPANIES_TECHNICIAN_REPL_ANNS_GRID.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.store.technician.COMPANIES_TECHNICIAN_REPL_ANNS_GRID', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            pageSize: 10,
            remoteSort: true,
            storeId: 'technician.COMPANIES_TECHNICIAN_REPL_ANNS_GRID',
            autoLoad: false,
            fields: [
                {
                    name: 'subStatus'
