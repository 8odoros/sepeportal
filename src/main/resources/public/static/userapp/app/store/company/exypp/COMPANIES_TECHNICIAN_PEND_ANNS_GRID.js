/*
 * File: app/store/company/exypp/COMPANIES_TECHNICIAN_PEND_ANNS_GRID.js
 *
 * Created by Marios K.
 *
...
Ext.define('MyApp.store.company.exypp.COMPANIES_TECHNICIAN_PEND_ANNS_GRID', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            pageSize: 10,
            remoteSort: true,
            storeId: 'company.exypp.COMPANIES_TECHNICIAN_PEND_ANNS_GRID',
            autoLoad: false,
            fields: [
                {
                    name: 'subStatus'
