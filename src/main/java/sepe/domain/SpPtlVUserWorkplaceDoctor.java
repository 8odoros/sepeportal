...
@Entity
@Table(name = "SP_PTL_V_USER_DOCTOR", schema = "SP_PTL", catalog = "")
public class SpPtlVUserWorkplaceDoctor {
    private Long id;
    ...
    public SpPtlVUserWorkplaceDoctor(){

    }
    public SpPtlVUserWorkplaceDoctor(Long id, String email) {
        this.id=id;
        this.email=email;
    }
    ...
    public boolean equals(Object o) {
        ...
        SpPtlVUserWorkplaceDoctor spPtlVUserSafetyTechnician = (SpPtlVUserWorkplaceDoctor) o;
