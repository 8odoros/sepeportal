 ...
 */
@Entity
@javax.persistence.Table(name = "SP_PTL_COMP_SUNDAY_PMT", schema = "SP_PTL", catalog = "")
public class SpPtlCompSundayPmt {
    private Long id;
    ...
    /////////////////////////////////////////////////
    // /*
    private Set<SpPtlCompSundayPmtPers> compSundayPmtPers = new HashSet<SpPtlCompSundayPmtPers>(0);

    @OneToMany(fetch = FetchType.EAGER, mappedBy = "compSundayPmt", cascade = CascadeType.ALL, orphanRemoval = true) // SHOULD BE EQUAL TO ATTRIBUTE NAME OF OTHER CLASS!!!!
    public Set<SpPtlCompSundayPmtPers> getCompSundayPmtPers() {
        return this.compSundayPmtPers;
    }

    public void setCompSundayPmtPers(Set<SpPtlCompSundayPmtPers> compSundayPmtPers) {
        this.compSundayPmtPers = compSundayPmtPers;
    }
    // */
    /////////////////////////////////////////////////

    @Nullable
    private SpPtlCompSundayPmtPersDTO[] pers;

    @Transient
    @Nullable
    public SpPtlCompSundayPmtPersDTO[] getPers() {
        return pers;
    }

    @Transient
    @Nullable
    public void setPers(@Nullable SpPtlCompSundayPmtPersDTO[] pers) {
        this.pers = pers;
    }
    ...
    public boolean equals(Object o) {
        ...
        SpPtlCompSundayPmt that = (SpPtlCompSundayPmt) o;
