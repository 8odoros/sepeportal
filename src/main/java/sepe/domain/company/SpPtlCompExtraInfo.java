 ...
 */
@Entity
@javax.persistence.Table(name = "SP_PTL_COMP_EXTRA_INFO", schema = "SP_PTL", catalog = "")
public class SpPtlCompExtraInfo {
    private Long id;
    ...
    private Long sepeDeptCombobox;

    @Basic
    @javax.persistence.Column(name = "SEPE_DEPT_COMBOBOX")
    public Long getSepeDeptCombobox() {
        return sepeDeptCombobox;
    }

    public void setSepeDeptCombobox(Long sepeDeptCombobox) {
        this.sepeDeptCombobox = sepeDeptCombobox;
    }
    ...
    public boolean equals(Object o) {
        ...
        SpPtlCompExtraInfo that = (SpPtlCompExtraInfo) o;
        ...
        if (inspectionDate != null ? !inspectionDate.equals(that.inspectionDate) : that.inspectionDate != null) return false;
        if (teKe != null ? !teKe.equals(that.teKe) : that.teKe != null) return false;
        if (sepeDeptCombobox != null ? !sepeDeptCombobox.equals(that.sepeDeptCombobox) : that.sepeDeptCombobox != null) return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (sepeDeptCombobox != null ? sepeDeptCombobox.hashCode() : 0);
        return result;
    }
}
