 ...
 */
@Entity
@javax.persistence.Table(name = "SP_PTL_ANONYMOUS_COMPLAINT", schema = "SP_PTL", catalog = "")
public class SpPtlAnonymousComplaint {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        SpPtlAnonymousComplaint that = (SpPtlAnonymousComplaint) o;
