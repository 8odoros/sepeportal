 ...
 */
@Entity
@javax.persistence.Table(name = "SP_PTL_V_COMP_TA_ANN_DIARY", schema = "SP_PTL", catalog = "")
public class SpPtlVCompTaAnnDiary {
    ...
    public boolean equals(Object o) {
        ...
        SpPtlVCompTaAnnDiary that = (SpPtlVCompTaAnnDiary) o;
