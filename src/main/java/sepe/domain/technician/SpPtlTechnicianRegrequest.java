 ...
 */
@Entity
@javax.persistence.Table(name = "SP_PTL_TECHNICIAN_REGREQUEST", schema = "SP_PTL", catalog = "")
public class SpPtlTechnicianRegrequest {
    private Long id;
    ...
    /////////////////////////////////////////////////
    ///*
    private Set<SpPtlTechnicianDiploma> technicianDiplomas = new HashSet<SpPtlTechnicianDiploma>(0);

    @ManyToMany(fetch = FetchType.LAZY, mappedBy = "technicianRegrequests") // Attrribute name of other domain object
    public Set<SpPtlTechnicianDiploma> getTechnicianDiplomas() {
        return this.technicianDiplomas;
    }

    public void setTechnicianDiplomas(Set<SpPtlTechnicianDiploma> technicianDiplomas) {
        this.technicianDiplomas = technicianDiplomas;
    }
    // */
    /////////////////////////////////////////////////
    ...
    public boolean equals(Object o) {
        ...
        SpPtlTechnicianRegrequest that = (SpPtlTechnicianRegrequest) o;
